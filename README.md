...
```text
참여 보장 = 추천시간을 따른 충전량 × 10P/kWh
성과 보너스 = 실제 Green Score 70점 이상인 충전량 × 20P/kWh
...
`1P=1원` 표시는 체감효과를 비교하기 위한 정책 시뮬레이션입니다. 실제 지급을 위해서는 충전사업자, 제주도, 렌터카사 또는 후원기업의 캠페인 예산과 충전 세션 연동이 필요합니다.
...
현재 자동검사는 데이터 8,760행, AI 결과 24시간, 목표 SOC 달성, 80:20 점수, 포인트 상한과 예보 실패 대응을 확인합니다.
...
| `tests/test_optimizer.py` | 최적화·포인트 규칙 단위테스트 7개 |
